...
self::TYPE_BOOKINGS,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['original_format'] = isset($data['original_format']) ? $data['original_format'] : null;
     ...
     * Sets main
     *
     * @param bool $main Indica si el teléfono es el principal
     *
     * @return $this
     */
     ...
     *
     * @param string $original_format Telefono expresado en formato del país al que pertenece (sin el +34 para el caso de España)
     *
     * @return $this
     */
     ...
     *
     * @param string $international_format Telefono expresado en formato internacional (con el +34 al principio para el caso de España)
     *
     * @return $this
     */
