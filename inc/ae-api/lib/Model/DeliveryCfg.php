 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DeliveryCfg implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeliveryCfg';
...
'zones' => '\Listae\Client\Model\DeliveryZones',
'enabled' => 'bool',
...
'zones' => 'setZones',
'enabled' => 'setEnabled',
'geocode_address' => 'setGeocodeAddress',
...
'zones' => 'getZones',
'enabled' => 'getEnabled',
'geocode_address' => 'getGeocodeAddress',
...
'currency' => 'getCurrency'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['geocode_address'] = isset($data['geocode_address']) ? $data['geocode_address'] : null;
     ...
     * Gets zones
     *
     * @return \Listae\Client\Model\DeliveryZones
     */
     ...
     * Sets zones
     *
     * @param \Listae\Client\Model\DeliveryZones $zones zones
     *
     * @return $this
     */
     ...
     * Sets enabled
     *
     * @param bool $enabled Delivery activado o no
     *
     * @return $this
     */
    ...
    /**
     * Gets geocode_address
     *
     * @return bool
     */
    public function getGeocodeAddress()
    {
        return $this->container['geocode_address'];
    }

    /**
     * Sets geocode_address
     *
     * @param bool $geocode_address Indica si la direccion hay que geoposicionarla o no
     *
     * @return $this
     */
    public function setGeocodeAddress($geocode_address)
    {
        $this->container['geocode_address'] = $geocode_address;
     ...
     * Sets delivery_price
     *
     * @param float $delivery_price Coste del reparto
     *
     * @return $this
     */
     ...
     *
     * @param int $min_time_in_advance Tiempo minimo para poder hacer el pedido para llevar
     *
     * @return $this
     */
     ...
     *
     * @param int $max_time_in_advance Tiempo máximo para poder hacer el pedido para llevar
     *
     * @return $this
     */
